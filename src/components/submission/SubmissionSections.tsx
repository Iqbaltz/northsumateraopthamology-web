        ...
        >
          <div className="flex items-center justify-between gap-6 bg-[linear-gradient(198deg,#fdfdfe_0%,#f1f5f6_100%)] p-6 sm:p-8 max-[700px]:flex-col max-[700px]:items-start">
            <div className="max-w-[760px]">
              <h2 className="text-xl sm:text-2xl font-bold leading-tight text-[#0c0c0c]">
                {content.title}
              </h2>
              <p className={`mt-2 ${cardTextClass} sm:text-base sm:leading-[25px]`}>
                {content.text}
              </p>
            </div>
            <a
              href={ojsLinks.contact}
              className={`${button} shrink-0 text-sm tracking-[0.04em] uppercase`}
            >
              {content.cta}
            </a>
          </div>
          ...
          <div className="flex items-center justify-between gap-x-8 gap-y-4 border-t border-[#e3eaef] px-6 py-4 sm:px-8 sm:py-5 max-[1200px]:flex-col max-[1200px]:items-start">
            <div>
              <p className="text-sm font-bold text-[#07868f]">{content.journalName}</p>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs sm:text-sm font-semibold text-[#0c0c0c]">
              <a
                className="flex items-center gap-2 whitespace-nowrap rounded-sm transition-colors duration-200 hover:text-[#07868f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#07868f]"
